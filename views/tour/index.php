            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a class="page-scroll" style="font-weight: 800"href="#classes">Classes</a></li>
                        <li><a class="page-scroll" style="font-weight: 800"href="#features">Features</a></li>
                        <li><a class="page-scroll" style="font-weight: 800"href="#review">Reviews</a></li>
                        <li><a class="page-scroll" style="font-weight: 800"href="#pricing">Pricing</a></li>
                        <li><a class="page-scroll" style="font-weight: 800"href="#contact">Contact</a></li>
                    </ul>
                </div>
            </div>
        </nav>
